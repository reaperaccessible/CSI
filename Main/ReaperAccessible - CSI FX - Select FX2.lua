...
if not track then
  ...
  reaper.PreventUIRefresh(-1)
  reaper.Undo_EndBlock("Select FX #2", -1)
  return
end
...
-- Select second FX in chain (slot 2 -> index 1) and show chain
reaper.TrackFX_Show(track, 1, 1) -- 1 = show chain and select that FX
