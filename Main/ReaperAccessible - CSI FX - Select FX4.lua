...
if not track then
  ...
  reaper.PreventUIRefresh(-1)
  reaper.Undo_EndBlock("Select FX #4", -1)
  return
end
...
-- Select fourth FX in chain (slot 4 -> index 3) and show chain
reaper.TrackFX_Show(track, 3, 1) -- 1 = show chain and select that FX
