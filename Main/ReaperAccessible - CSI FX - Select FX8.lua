...
if not track then
  ...
  reaper.PreventUIRefresh(-1)
  reaper.Undo_EndBlock("Select FX #8", -1)
  return
end
...
-- Select eighth FX in chain (slot 8 -> index 7) and show chain
reaper.TrackFX_Show(track, 7, 1) -- 1 = show chain and select that FX
